...
<div style="display: grid; grid-template-columns: 2fr 1fr; gap: 2.5rem; align-items: start;">
  ...
  <div>
    <section>
      <h1 style="font-size: 2.2rem; margin-bottom: 0.5rem;"><?= htmlspecialchars($offre['titre']) ?></h1>
  ...
  <aside>
    ...
    <div style="border: 1px dashed var(--border); padding: 1.5rem; border-radius: 8px;">
        ...
        <a href="formulaire-offre.php?id=<?= (int) $offre['id'] ?>" class="btn-cta" style="display: block; text-align: center; font-size: 0.85rem; margin-bottom: 0.5rem;">Modifier l'offre</a>
