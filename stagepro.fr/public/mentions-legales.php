...
<div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 2rem; margin-top: 3rem;">
    ...
    <section style="background: var(--surface); padding: 1.5rem; border-radius: 8px; border: 1px solid var(--border);">
      ...
      <ul style="list-style: none; margin-top: 1rem; font-size: 0.85rem; color: var(--text-muted);">
        <li>• <strong>Hébergeur :</strong> Serveur local (WAMP/Laragon)</li>
...
<div style="text-align: center; margin-bottom: 3rem;">
    <a href="index.php" class="btn-cta" style="background: transparent; border: 1px solid var(--accent-blue); color: var(--accent-blue);">
        Retour à l'accueil
    </a>
</div>
