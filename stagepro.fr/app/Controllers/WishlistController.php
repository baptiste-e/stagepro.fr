...
class WishlistController {
    ...
    public function index() {
        ...
        // -----------------------------
        // PAGINATION SQL : 6 favoris par page
        // -----------------------------
        $favorisParPage = 6;
        $pageActuelle = max(1, (int)($_GET['pagination'] ?? 1));

        $totalFavoris = $this->model->countUserWishlist($id_user);
        ...
        // Récupération uniquement des 6 favoris de la page actuelle
        $wishlist = $this->model->getUserWishlistPaginated($id_user, $favorisParPage, $offset);

        // On conserve la variable avant pagination
        $wishlist_est_vide = ($totalFavoris === 0);
